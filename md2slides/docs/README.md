...
| 2026-03-25 | 架构改进 | ✅ 完成 | HTML 反向同步 tree.style，HTML 成为唯一事实源 |
| 2026-03-25 | 主题扩充 v2.0 | ✅ 完成 | 新增 tech-terminal/keynote-white/celebration/caring-green 共 4 套主题 |
| 2026-03-25 | template 修复 | ✅ 完成 | 修复硬编码颜色(B+D)、hljs 报错(C)、表格居中(E)；新增 3 个 CSS 变量 |
